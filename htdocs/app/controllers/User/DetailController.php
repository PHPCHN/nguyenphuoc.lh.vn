...
class DetailController extends BaseUserController
{
    ...
    public function get_sitemap_index() {
      $sitemap = Seo::sitemap_index();
      return $this->sitemap_index($sitemap);
    }

    public function get_sitemap_about() {
      $sitemap = Seo::sitemap_about();
      return $this->sitemap($sitemap);
    }

    public function get_sitemap_product() {
      $sitemap = Seo::sitemap_product();
      return $this->sitemap($sitemap);
    }

    public function get_sitemap_news() {
      $sitemap = Seo::sitemap_news();
      return $this->sitemap($sitemap);
    }

    public function get_sitemap_project() {
      $sitemap = Seo::sitemap_project();
      return $this->sitemap($sitemap);
    }

    public function get_sitemap_prov() {
      $sitemap = Seo::sitemap_prov();
      return $this->sitemap($sitemap);
    }
    ...
    private function sitemap_index($sitemap) {
      $content = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>
