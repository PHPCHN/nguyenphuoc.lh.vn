<link rel="icon" href="{{asset('asset/img/iconweb.png')}}">
<title>@yield('title')</title>
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0, minimum-scale=1.0">
<meta name="keywords" content="@yield('keywords')">
<link rel="canonical" href="{{asset(Request::path())}}">
<link rel="amphtml" href="{{asset('amp/'.Request::path())}}">
...
<link rel="stylesheet" href="{{asset('asset/bootstrap/css/bootstrap.min.css')}}" media="all" type="text/css">
...
<link rel="stylesheet" href="{{asset('asset/css/swiper.min.css')}}" media="all" type="text/css">
