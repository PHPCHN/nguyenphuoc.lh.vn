...
UPDATE `products` SET `top`=1 WHERE `code` in ('KX-1004C','KX-1003C','KX-1011N','KX-1012N','KX-7104D4','KX-7104D5','KX-7104TD4','KX-7104TD5','GS-132','GS-232','GS-138','GS-2100','KB-VDP02G','KB-VDP01H','KB-VDP01G','KB-VDP01GN')
...
UPDATE `products` SET `top`=1 WHERE `code` in (
'KX-1004C',
'KX-1003C',
'KX-1011N',
'KX-1012N',
